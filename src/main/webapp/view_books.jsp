	...
	<div class="container p-3">
		<div class="row">
			...
			<div class="col-md-6 border p-5 text-center bg-white">
				...
				<h2>Category: <span class="text-success"><%=bk.getCategories() %></span></h2>
			...
			<div class="col-md-6 border p-5 bg-white">
				<h2 class="text-danger text-center"><%=bk.getBookName()%></h2>
				<%
				if (bcate.equals("Old")) {
				%>
				<div>
					<h4 class="text-center text-primary">Contact to Seller</h4>
