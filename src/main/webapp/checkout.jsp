	...
	<div class="container">
		<div class="row mt-5">
			<div class="col-md-6">
				<!-- card -->
				<div class="card">
					<h3 style='margin-top:1px;padding:6px;' class="text-center bg-dark text-warning mb-2">Your Selected Item</h3>
					<div class="card-body">
			...
			<div class="col-md-6">
				<div class="card">
					<h3 style='margin-top:1px;padding:6px;' class="text-center bg-dark text-warning mb-2">Enter Your Order Details here</h3>
					<div class="card-body">
						<%
						if (user != null) {
						%>
						<form action="orderSucessServlet?uid=<%=user.getId()%>" method="post">
							...
							<div class="container text-center text-white">
								...
								%>
								<a style='text-align:center;'  data-toggle="modal" data-target="#checkItem" type="submit"
									class="btn btn-warning">Order Now</a>
								<%
								}
								%>
								<a href="index1.jsp" type="submit" class="btn btn-success">Continue
									Shopping</a>
							</div>
						</form>
						<%
