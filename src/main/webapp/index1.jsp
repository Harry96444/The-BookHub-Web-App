...
<body style="background: linear-gradient(90deg, rgba(36,0,0,1) 0%, rgba(216,225,244,1) 0%);">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="img/C2.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
	...
	<div class="container p-4">
		...
		<div class="text-center text-white mt-2">
			<a class="btn btn-danger btn-lg" href="recent_book.jsp">View All</a>
		</div>
	</div>
	...
	<div class="container p-4">
		...
		<br>
		<div class="text-center text-white mt-2">
			<a class="btn btn-danger btn-lg" href="new_book.jsp">View All</a>
		</div>
	</div>
	...
	<div class="container p-4">
        ...
        <br>
		<div class="text-center text-white mt-2">
			<a class="btn btn-danger btn-lg" href="old_book.jsp">View All</a>
		</div>
	</div>
